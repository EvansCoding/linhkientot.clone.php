...
<head>
  ...
  <link rel="icon" type="image/png" href="public/admin/assets/img/icon/icons8_google_cloud_platform_16.png">
  ...
  <div class="wrapper fadeInDown">
    <div id="formContent">
      <div class="fadeIn first">
        <img src="public\admin\assets\img\logo.linh-kien.png" style="padding: 10px 0px;" id="icon" alt="User Icon" />
      </div>
      ...
      <form>
        ...
        <input type="button" id="btnLogin" class="fadeIn fourth" value="Đăng nhập" onclick="login()">
      </form>
    </div>
  </div>
  <script>
